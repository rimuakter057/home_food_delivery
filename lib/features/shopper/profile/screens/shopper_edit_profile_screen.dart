...
/// The Shopper "Edit Profile" form (Figma node 331:5436): identical
/// avatar-ring + camera-badge pattern to [HostEditProfileScreen].
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: responsive.spacing(12)),
                    AppTextField(label: AppStrings.fullName, hint: AppStrings.fullName, controller: _nameController),
                    SizedBox(height: responsive.spacing(12)),
                    AppTextField(label: AppStrings.phoneNumber, hint: AppStrings.phoneNumber, controller: _phoneController, keyboardType: TextInputType.phone),
                    SizedBox(height: responsive.spacing(12)),
                    AppTextField(label: AppStrings.email, hint: AppStrings.email, controller: _emailController, keyboardType: TextInputType.emailAddress),
                    SizedBox(height: responsive.spacing(12)),
