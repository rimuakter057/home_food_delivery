...
/// The Shopper "Notifications" preferences screen (Figma node 206:5958) —
/// the same layout and [PillToggleSwitch] as [HostNotificationsScreen],
/// with the shopper's own 6-item list (no "Promotions & Deals").
class ShopperNotificationsScreen extends StatefulWidget {
  const ShopperNotificationsScreen({super.key});

  @override
  State<ShopperNotificationsScreen> createState() => _ShopperNotificationsScreenState();
}

class _ShopperNotificationsScreenState extends State<ShopperNotificationsScreen> {
  final _prefs = [
